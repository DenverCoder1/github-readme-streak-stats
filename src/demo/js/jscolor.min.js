  ...
  var jscolor = (function () {
    var jsc = {
      ...
      parseOptionsStr: function (str) {
        ...
        try {
          ...
          if (!jsc.pub.looseJSON) {
            ...
            try {
              opts = new Function(
                "var opts = (" + str + '); return typeof opts === "object" ? opts : {};'
              )();
            } catch (eEval) {
      ...
      getPickerDims: function (thisObj) {
        ...
        var sliderSpace =
          2 * thisObj.controlBorderWidth + 2 * jsc.getControlPadding(thisObj) + thisObj.sliderSize;
      ...
      onPaletteSampleClick: function (e) {
        ...
        if (color.rgba[3] === null) {
          if (
            ...
            (thisObj.paletteSetsAlpha === "auto" && thisObj._paletteHasTransparency)
          ) {
            color.rgba[3] = 1;
          }
        }
      ...
      setPad: function (thisObj, e, ofsX, ofsY) {
        ...
        var x =
          ofsX + pointerAbs.x - jsc._pointerOrigin.x - thisObj.padding - thisObj.controlBorderWidth;
        var y =
          ofsY + pointerAbs.y - jsc._pointerOrigin.y - thisObj.padding - thisObj.controlBorderWidth;
      ...
      pub: function (targetElement, opts) {
        ...
        this.hasAlphaChannel = function () {
          if (this.alphaChannel === "auto") {
            return (
              this.format.toLowerCase() === "any" ||
              jsc.isAlphaFormat(this.getFormat()) ||
              this.alpha !== undefined ||
              this.alphaElement !== undefined
            );
          }
        ...
        this.exposeColor = function (flags) {
          ...
          if (!(flags & jsc.flags.leavePreview) && this.previewElement) {
            var previewPos = null;
            if (
              jsc.isTextInput(this.previewElement) ||
              (jsc.isButton(this.previewElement) && !jsc.isButtonEmpty(this.previewElement))
            ) {
        ...
        function drawPicker() {
          ...
          p.padM.style.width =
            THIS.padding + 2 * THIS.controlBorderWidth + THIS.width + controlPadding + "px";
          ...
          p.sldB.style.left =
            THIS.padding + THIS.width + 2 * THIS.controlBorderWidth + 2 * controlPadding + "px";
          ...
          p.sldM.style.left =
            THIS.padding + THIS.width + 2 * THIS.controlBorderWidth + controlPadding + "px";
          ...
          p.asldB.style.left =
            ...
            controlPadding +
            (displaySlider
              ? THIS.sliderSize + 3 * controlPadding + 2 * THIS.controlBorderWidth
              : 0) +
            "px";
          ...
          p.asldM.style.width =
            ...
            2 * controlPadding +
            2 * THIS.controlBorderWidth +
            Math.max(0, THIS.padding - controlPadding) +
            "px";
          ...
          p.btn.style.maxWidth =
            pickerDims.contentW - 2 * THIS.controlBorderWidth - 2 * btnPadding + "px";
      ...
      if (jsc.pub.lookupClass) {
        try {
          jsc.installBySelector(
            "input." + jsc.pub.lookupClass + ", " + "button." + jsc.pub.lookupClass,
            rootNode
          );
        } catch (e) {}
      }
