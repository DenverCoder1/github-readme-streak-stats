...
<div class="github">
    ...
    <a class="github-button" href="https://github.com/sponsors/denvercoder1"
       data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-heart" data-size="large"
       aria-label="Sponsor @denvercoder1 on GitHub">Sponsor</a>
    <!-- View on GitHub -->
    ...
    <a class="github-button" href="https://github.com/denvercoder1/github-readme-streak-stats"
       ...
       data-show-count="true" aria-label="Star denvercoder1/github-readme-streak-stats on GitHub">Star</a>
</div>
...
<div class="container">
    <div class="properties">
        ...
        <form class="parameters">
            ...
            <input class="param" type="number" id="border-radius" name="border_radius" placeholder="4.5" value="4.5"
                   step="0.1" min="0"/>
            ...
            <input class="param" type="number" id="card-width" name="card_width" placeholder="495" value="495" step="1"
                   min="300"/>

            <label for="card-height">Card Height</label>
            <input class="param" type="number" id="card-height" name="card_height" placeholder="195" value="195" step="1"
                   min="170"/>
            ...
            <details class="advanced">
                ...
                <div class="content">
                    <div class="radio-buttons parameters" role="radiogroup" aria-labelledby="background-type-label">
                        ...
                        <div class="radio-button-group">
                            <div>
                                <input type="radio" id="background-type-solid" name="background-type" value="solid"
                                       checked/>
                                <label for="background-type-solid">Solid</label>
                            </div>
                            <div>
                                <input type="radio" id="background-type-gradient" name="background-type"
                                       value="gradient"/>
                ...
                <button id="clear-button" class="btn" type="button" onclick="preview.removeAllProperties()" disabled>
                    Clear Options
                </button>
    ...
    <div class="output top-bottom-split">
        <div class="top">
            ...
            <div>
                ...
                <button class="copy-button btn tooltip copy-md" onclick="clipboard.copy(this);"
                        onmouseout="tooltip.reset(this);" disabled>
                    Copy To Clipboard
                </button>
            </div>
            ...
            <div>
                ...
                <button class="copy-button btn tooltip copy-html" onclick="clipboard.copy(this);"
                        onmouseout="tooltip.reset(this);" disabled>
                    Copy To Clipboard
                </button>
            </div>
            ...
            <div>
                ...
                <button class="copy-button btn tooltip copy-json" onclick="clipboard.copy(this);"
                        onmouseout="tooltip.reset(this);" disabled>
                    Copy To Clipboard
                </button>
            </div>
        ...
        <div class="bottom">
            <a href="https://github.com/DenverCoder1/github-readme-streak-stats/blob/main/docs/faq.md" target="_blank"
