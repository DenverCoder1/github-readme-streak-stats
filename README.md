...
|       `card_height`        |  Height of the card in pixels (Default: `195`)   |                              Positive integer, minimum width is 195px                              |
